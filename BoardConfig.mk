...
DEVICE_PATH := device/allwinner/diana-p1
...
TARGET_KERNEL_CONFIG := diana-p1_defconfig
TARGET_KERNEL_SOURCE := kernel/allwinner/diana-p1
...
BOARD_ALLWINNER_DYNAMIC_PARTITIONS_PARTITION_LIST := system system system_dlkm vendor vendor_dlkm product
